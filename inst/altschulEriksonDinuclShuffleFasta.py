...
# This code is modified to run with python2.7 and use Bio library and
# take a fasta file as input. It also suffles the sequences n times.
#
# Kourosh Zarringhalam Feb 3, 2014
...
if __name__ == '__main__':
  #parser = OptionParser()
  #parser.add_option("-i", dest = "in_file_name",
  #                  help = "Path to the input fasta file",
  #                  metavar = "FILE")
  #parser.add_option("-n", dest = "n",type="int", default=1,
  #                  help = "Number of times to shuffle the sequence. Default is 1.",
  #                  metavar = "FILE")
  #parser.add_option("-o", dest = "out_file_name",
  ...
  #sRNA = open(in_file_name)
  #shuffleRNA = open(out_file_name, 'w')

  #counter = 1
  #for i in SeqIO.parse(sRNA,'fasta'):
    #s = str(i.seq)
    #s = s.upper()
    #s = s.replace("T","U")
    #print(s)
    ...
    #  s = dinuclShuffle(s)
    #shuffleRNA.writelines('>Suffle_'+i.id + '\n')
    #shuffleRNA.writelines(dinuclShuffle(s) + '\n')
